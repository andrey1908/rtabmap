...
ColoredOccupancyGrid::ColoredOccupancyGrid(const ParametersMap& parameters) :
	cellSize_(Parameters::defaultGridCellSize()),
	missProb_(logodds(Parameters::defaultGridGlobalProbMiss())),
	hitProb_(logodds(Parameters::defaultGridGlobalProbHit())),
...
void ColoredOccupancyGrid::parseParameters(const ParametersMap & parameters)
{
...
void ColoredOccupancyGrid::addLocalMap(int nodeId, LocalMap localMap)
{
	UASSERT(nodeId >= 0);
...
void ColoredOccupancyGrid::addLocalMap(int nodeId, const Transform& pose, LocalMap localMap)
{
	UASSERT(nodeId >= 0);
	UASSERT(nodes_.empty() || nodes_.rbegin()->first < nodeId);
...
void ColoredOccupancyGrid::cacheCurrentMap()
{
	cachedPoses_.clear();
...
bool ColoredOccupancyGrid::checkIfCachedMapCanBeUsed(
...
void ColoredOccupancyGrid::useCachedMap()
{
	clear();
...
int ColoredOccupancyGrid::tryToUseCachedMap(const std::map<int, Transform>& updatedPoses)
{
...
void ColoredOccupancyGrid::updatePoses(const std::map<int, Transform>& updatedPoses,
...
ColoredOccupancyGrid::TransformedLocalMap ColoredOccupancyGrid::transformLocalMap(
...
void ColoredOccupancyGrid::createOrResizeMap(const MapLimits& newMapLimits)
{
...
void ColoredOccupancyGrid::deployLocalMap(int nodeId)
{
	deployLocalMap(nodes_.at(nodeId));
}

void ColoredOccupancyGrid::deployLocalMap(const Node& node)
{
...
ColoredOccupancyGrid::OccupancyGrid ColoredOccupancyGrid::getOccupancyGrid() const
{
...
ColoredOccupancyGrid::OccupancyGrid ColoredOccupancyGrid::getProbOccupancyGrid() const
{
...
ColoredOccupancyGrid::ColorGrid ColoredOccupancyGrid::getColorGrid() const
{
...
void ColoredOccupancyGrid::clear()
{
